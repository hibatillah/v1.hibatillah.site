...
const AboutContent = () => {
  return (
    <>
      ...
      {/* cta */}
      <m.button variants={text} className="w-fit mt-3 rounded-full overflow-hidden group">
        <a href="https://read.cv/hibatillah" className="flex items-center gap-1 px-4 py-1.5 rounded-full border border-main-500 text-main-300 group-hover:text-main-100 group-hover:scale-90 group-hover:border-main-400 transition-all ease-out duration-300">
          <svg
