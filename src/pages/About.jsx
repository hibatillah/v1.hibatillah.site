...
const AboutContent = () => {
  return (
    <>
      ...
      {/* cta */}
      <m.button variants={text} className="w-fit mt-3 group overflow-hidden">
        <a href="https://read.cv/hibatillah" className="ps-3 pe-4 py-2 flex items-center gap-2 text-main-200 hover:text-white rounded-md bg-main-700 active:bg-main-800">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="w-5 -translate-x-10 group-hover:translate-x-0 transition-all ease-out duration-300"
            viewBox="0 0 256 256">
            <path
              fill="currentColor"
          ...
          <span className="-translate-x-3 transition-all ease-out duration-300 group-hover:translate-x-0">read.cv</span>
        </a>
      </m.button>
    </>
  );
